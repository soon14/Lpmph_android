...
public class Helper {
    ...
    public static String[] getPhoneInfo(Context ctx) {
        ...
        LogUtils.i("PhoneInfo callNumber::::" + pnum);
        //
        pi[0] = tm.getSubscriberId();// IMSI
        LogUtils.i("PhoneInfo IMSI::::" + pi[0]);
        pi[1] = tm.getDeviceId();// IMEI
        LogUtils.i("PhoneInfo IMEI::::" + pi[1]);
        //
        LogUtils.i("PhoneInfo manufacture::::" + Build.MANUFACTURER);// 厂商
        LogUtils.i("PhoneInfo model::::" + Build.MODEL);// 型号
        LogUtils.i("PhoneInfo VERSION::::" + "android_"
        ...
        LogUtils.i("PhoneInfo versionCode::::" + pi[2]);
