...
public class StoreRecyclerSalesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        {
            PromSkuRespVO promSkuRespVO = mList.get(position - mHeaderCount);
            if (StringUtil.isNotEmpty(promSkuRespVO.getNameShort())) {
                String activity = " " + promSkuRespVO.getNameShort() + " ";
                String str = activity + " " + Html.fromHtml(promSkuRespVO.getGdsName());
                ...
                ((ContentViewHolder) holder).itemName.setText(Html.fromHtml(promSkuRespVO.getGdsName()));
            }
            if (StringUtils.equals(BuildConfig.BUILD_TYPE, Constant.BUILD_TYPE_PMPH)) {
            ...
            MoneyUtils.showSpannedPrice(((ContentViewHolder) holder).itemPrice, MoneyUtils.GoodListPrice(promSkuRespVO.getPromPrice()));
            ((ContentViewHolder) holder).itemPeople.setText(promSkuRespVO.getSales() + "人付款");
            GlideUtil.loadImg(mContext, promSkuRespVO.getImageUrl(), ((ContentViewHolder) holder).itemImg);
        }
    ...
    public PromSkuRespVO getItem(int location) {
