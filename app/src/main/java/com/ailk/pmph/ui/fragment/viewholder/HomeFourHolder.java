 ...
 */
@HomeViewType(ViewType=4)
public class HomeFourHolder extends HomeViewHolder {
    ...
    public HomeFourHolder(Activity activity,LayoutInflater inflater, ViewGroup viewGroup) {
    ...
    public void initData(Cms010Resp.Model model) {
        ...
        setImageViewImg(items.get(3).getImgUrl(),img3,mAQuery,320);
