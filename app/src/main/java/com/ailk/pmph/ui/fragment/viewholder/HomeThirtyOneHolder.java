 ...
 */
@HomeViewType(ViewType=31)
public class HomeThirtyOneHolder extends HomeViewHolder {

    private ImageView img0;
    private ImageView img1;
    private ImageView img2;

    public HomeThirtyOneHolder(Activity activity, LayoutInflater inflater, ViewGroup viewGroup) {
        super(activity,inflater,viewGroup, R.layout.home_three2_layout,R.dimen.home_modey_body_width,R.dimen.home_model_type1_height);
    }
