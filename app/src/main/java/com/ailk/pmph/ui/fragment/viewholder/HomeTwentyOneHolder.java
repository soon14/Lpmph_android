 ...
 */
@HomeViewType(ViewType=21)
public class HomeTwentyOneHolder extends HomeViewHolder {

    private ImageView img0;
    private ImageView img1;

    public HomeTwentyOneHolder(Activity activity, LayoutInflater inflater, ViewGroup viewGroup) {
