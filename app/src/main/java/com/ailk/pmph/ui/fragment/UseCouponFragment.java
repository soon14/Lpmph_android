...
public class UseCouponFragment extends BaseFragment {
    ...
    PullToRefreshListView lvUseList;
    ...
    public void initView(View view){
        lvUseList.setMode(PullToRefreshBase.Mode.BOTH);
        lvUseList.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
            @Override
    ...
    private void requestCoup001(boolean isShowProgress){
        ...
        request.setOpeType(Constant.OPE_TYPE_USE);
        ...
        getJsonService().requestCoup001(getActivity(), request, isShowProgress, new JsonService.CallBack<Coup001Resp>() {
            ...
            public void oncallback(Coup001Resp coup001Resp) {
                ...
                if (resList!=null && resList.size()==0) {
                    ...
                    adapter = new CouponListAdapter(getActivity(), resList, Constant.OPE_TYPE_USE);
                    lvUseList.setAdapter(adapter);
                    lvUseList.onRefreshComplete();
                }
            }
