 ...
 * 时间: 2016/10/11 15:54
 */
@HomeViewType(ViewType=40)
public class HomeFortyHolder extends HomeViewHolder {
    ...
    public HomeFortyHolder(Activity activity, LayoutInflater inflater, ViewGroup viewGroup) {
    ...
    public void initData(Cms010Resp.Model model) {
        ...
        setImageViewImg(items.get(0).getImgUrl(),img0,mAQuery,160);
        setImageViewImg(items.get(1).getImgUrl(),img1,mAQuery,160);
