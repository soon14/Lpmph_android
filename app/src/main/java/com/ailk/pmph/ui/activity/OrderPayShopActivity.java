 ...
 * 时间: 2016/4/10 17:18
 */
public class OrderPayShopActivity extends BaseActivity implements View.OnClickListener{
    ...
    public void initView() {
        ...
        if (bundle != null) {
            pay002Resp = (Pay002Resp) bundle.get("pay002Resp");
            tvRealMoney.setText(MoneyUtils.GoodListPrice(bundle.getLong("realMoney")));
        }
        if (pay002Resp != null) {
            wayList = pay002Resp.getWayList();
        }
        if (wayList.size() > 0) {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_confirm:
                ...
                if (rbHong.isChecked()) {
                    requestAiPayInfo(pay002Resp);
                }
                if (rbAli.isChecked()) {
                    requestAliPayInfo(pay002Resp);
                }
                if (rbAbc.isChecked()) {
                    requestAbcPayInfo(pay002Resp);
                }
                if (rbWechat.isChecked()) {
                    requestWechatPayInfo(pay002Resp);
                }
                break;
        }
    }
     ...
     * @param resp
     */
    private void requestAbcPayInfo(Pay002Resp resp) {
     ...
     * @param resp
     */
    private void requestAiPayInfo(Pay002Resp resp) {
        if (System.currentTimeMillis() - lastRequest < CLICK_INTERVAL) {
            return;
        }
        lastRequest = System.currentTimeMillis();
                ...
                if (StringUtils.equalsIgnoreCase(Constant.UNION_PAY_ID, payWayItem.getId())) {
                    ...
                    NetCenter.build(this)
                        ...
                        public void call(Pay004Resp pay004Resp) {
                            ...
                            Intent intent = new Intent(OrderPayShopActivity.this, AiPayActivity.class);
                        ...
                        public void call(Throwable throwable) {
                            ToastUtil.show(OrderPayShopActivity.this, throwable.getMessage());
                        }
                    });
                }
            }
     ...
     * @param resp
     */
    private void requestAliPayInfo(final Pay002Resp resp) {
        if (System.currentTimeMillis() - lastRequest < CLICK_INTERVAL) {
            return;
        }
        lastRequest = System.currentTimeMillis();
                ...
                if (StringUtils.equalsIgnoreCase(Constant.ALI_PAY_ID, payWayItem.getId())) {
                    ...
                    NetCenter.build(this)
                        ...
                        public void call(Pay004Resp pay004Resp) {
                            ...
                            AliPayUtils aliPayUtils = new AliPayUtils(OrderPayShopActivity.this);
    ...
    private void requestWechatPayInfo(Pay002Resp resp) {
        if (System.currentTimeMillis() - lastRequest < CLICK_INTERVAL) {
            return;
        }
        lastRequest = System.currentTimeMillis();
                ...
                if (StringUtils.equalsIgnoreCase(Constant.WECHAT_PAY_ID, payWayItem.getId())) {
                    ...
                    NetCenter.build(this)
                            ...
                            .subscribe(new Action1<Pay004Resp>() {
                                ...
                                public void call(Pay004Resp pay004Resp) {
                                    Map<String, String> formData = pay004Resp.getFormData();
                                    IWXAPI iwxapi = WXAPIFactory.createWXAPI(OrderPayShopActivity.this, null);
