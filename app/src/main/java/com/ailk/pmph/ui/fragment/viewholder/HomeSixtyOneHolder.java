...
public class HomeSixtyOneHolder extends HomeViewHolder {
    ...
    public HomeSixtyOneHolder(Activity activity, LayoutInflater inflater, ViewGroup viewGroup) {
    ...
    public void initData(Cms010Resp.Model model) {
        ...
        setImageViewImg(items.get(0).getImgUrl(),img0,mAQuery,214);
        setImageViewImg(items.get(1).getImgUrl(),img1,mAQuery,214);
        setImageViewImg(items.get(2).getImgUrl(),img2,mAQuery,214);
        setImageViewImg(items.get(3).getImgUrl(),img3,mAQuery,214);
        setImageViewImg(items.get(4).getImgUrl(),img4,mAQuery,214);
        setImageViewImg(items.get(5).getImgUrl(),img5,mAQuery,214);
