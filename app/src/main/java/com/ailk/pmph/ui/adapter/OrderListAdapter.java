...
public class OrderListAdapter extends BaseExpandableListAdapter {
    ...
    private CheckLogisticsInterface checkLogisticsInterface;

    public OrderListAdapter(Context context, List<Ord01201Resp> groups, Map<String, List<Ord01202Resp>> children) {
    ...
    public void setCheckLogisticsInterface(CheckLogisticsInterface checkLogisticsInterface) {
        this.checkLogisticsInterface = checkLogisticsInterface;
    }
...
//        groupHolder.ivDelete.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                deleteOrderInterface.deleteOrder(shop, groupPosition);
//            }
//        });
        return convertView;
    }
    ...
    public View getChildView(final int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (isLastChild) {
            ...
            {
                if (StringUtils.equals("1", shop.getDispatchType())) {//自提
                    childHolder.tvBuyAgain.setVisibility(View.VISIBLE);
                    childHolder.tvBuyAgain.setText("查看物流");
                } else {
                    childHolder.tvBuyAgain.setVisibility(View.GONE);
                }
                childHolder.tvGoPay.setVisibility(View.VISIBLE);
        ...
        childHolder.tvBuyAgain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (StringUtils.equals(childHolder.tvBuyAgain.getText().toString(),"查看物流"))
                {
                    checkLogisticsInterface.checkLogistics(shop);
                }
            }
        });
        return convertView;
     ...
     * 查看物流
     */
    public interface CheckLogisticsInterface {
        void checkLogistics(Ord01201Resp shop);
    }
