 ...
 * 时间: 2016/10/11 15:54
 */
@HomeViewType(ViewType=240)
public class HomeAdFourHolder extends HomeViewHolder {
    ...
    public HomeAdFourHolder(Activity activity, LayoutInflater inflater, ViewGroup viewGroup) {
        super(activity,inflater,viewGroup, R.layout.home_ad_four_layout, R.dimen.home_modey_body_width, R.dimen.home_model_type0_height);
    }
    ...
    public void initData(Cms010Resp.Model model) {
        ...
        setImageViewImg(items.get(0).getImgUrl(),img0,mAQuery,140);
        setImageViewImg(items.get(1).getImgUrl(),img1,mAQuery,140);
        setImageViewImg(items.get(2).getImgUrl(),img2,mAQuery,140);
        setImageViewImg(items.get(3).getImgUrl(),img3,mAQuery,140);
