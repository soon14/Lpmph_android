 ...
 */
@HomeViewType(ViewType=11)
public class HomeElevenHolder extends HomeViewHolder {

    private ImageView img0;

    public HomeElevenHolder(Activity activity, LayoutInflater inflater, ViewGroup viewGroup) {
