...
public class SignInGoodListAdapter extends BaseAdapter {

    private Context mContext;
    private List<PointGdsDetailBaseInfo> mList;
    private RedirectToDetailInterface redirectToDetailInterface;

    public SignInGoodListAdapter(Context context, List<PointGdsDetailBaseInfo> list){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_sign_in_good_list, parent, false);
