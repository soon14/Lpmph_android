 ...
 * 时间: 2016/4/9 00:09
 */
public class OrderListPayActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void initView() {
        ...
        if (bundle != null) {
            ...
            realMoney = bundle.getLong("realMoney");
        }
        if (realMoney != null) {
                ...
                if (StringUtils.equalsIgnoreCase(Constant.UNION_PAY_ID, payWayItem.getId())) {
                    ...
                    NetCenter.build(this)
                        ...
                        public void call(Pay004Resp pay004Resp) {
                            ...
                            Intent intent = new Intent(OrderListPayActivity.this, AiPayActivity.class);
                        ...
                        public void call(Throwable throwable) {
                            ToastUtil.show(OrderListPayActivity.this, throwable.getMessage());
                        }
                    });
                }
            }
                ...
                if (StringUtils.equalsIgnoreCase(Constant.ALI_PAY_ID, payWayItem.getId())) {
                    ...
                    NetCenter.build(this)
                        ...
                        public void call(Pay004Resp pay004Resp) {
                            ...
                            AliPayUtils aliPayUtils = new AliPayUtils(OrderListPayActivity.this);
                ...
                if (StringUtils.equalsIgnoreCase(Constant.WECHAT_PAY_ID, payWayItem.getId())) {
                    ...
                    NetCenter.build(this)
                            ...
                            .subscribe(new Action1<Pay004Resp>() {
                                ...
                                public void call(Pay004Resp pay004Resp) {
                                    Map<String, String> formData = pay004Resp.getFormData();
                                    IWXAPI iwxapi = WXAPIFactory.createWXAPI(OrderListPayActivity.this, null);
