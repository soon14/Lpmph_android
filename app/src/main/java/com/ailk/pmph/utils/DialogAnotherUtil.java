 ...
 *
 */
public class DialogAnotherUtil {
...
//		}
     ...
     *
     */
    public static ProgressDialog getCustomerProgressDialog(Context context,String title) {
        if (mAlertDialog != null) {
            if(mAlertDialog.isShowing())
                mAlertDialog.dismiss();
            mAlertDialog = null;
        ...
        mAlertDialog = new ProgressDialog(context);
        ((ProgressDialog)mAlertDialog).setProgressStyle(ProgressDialog.STYLE_SPINNER);
        mAlertDialog.setTitle(title);
        mAlertDialog.setCancelable(false);
        return (ProgressDialog)mAlertDialog;
    }
