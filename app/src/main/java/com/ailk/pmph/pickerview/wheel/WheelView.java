...
package com.ailk.pmph.pickerview.wheel;
...
import com.ailk.pmph.pickerview.adapter.WheelViewAdapter;
import com.ailk.pmph.pickerview.config.DefaultConfig;
...
//        mPaintLineRight.setStrokeWidth(context.getResources().getDimensionPixelSize(R.dimen.picker_line_width));
    ...
    public void setConfig(PickerConfig config) {
        if (StringUtils.equals(BuildConfig.BUILD_TYPE, Constant.BUILD_TYPE_PMPH)) {
            mPaintLineCenter.setColor(config.mThemeOrangeColor);
            mPaintRectCenter.setColor(config.mThemeOrangeColor);
        } else {
