package com.ailk.jazzyviewpager;
...
public class JazzyViewPager extends ViewPager {
    ...
    public TransitionEffect[] transitions = new TransitionEffect[]{
            TransitionEffect.Standard, TransitionEffect.Tablet,
            TransitionEffect.CubeIn, TransitionEffect.CubeOut,
            TransitionEffect.FlipVertical, TransitionEffect.FlipHorizontal,
            TransitionEffect.Stack, TransitionEffect.ZoomIn,
            TransitionEffect.ZoomOut, TransitionEffect.RotateUp,
    ...
    public JazzyViewPager(Context context, AttributeSet attrs) {
        ...
        setTransitionEffect(transitions[effect]);
        setFadeEnabled(ta.getBoolean(
                R.styleable.JazzyViewPager_viewfadeEnabled, false));
