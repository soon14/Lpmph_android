...
public class InteSearchResultActivity extends BaseActivity implements View.OnClickListener{
    ...
    public void initData() {
        isGoodList = getIntent().getBooleanExtra("isGoodList", false);
        ...
        mGridLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
            ...
            public int getSpanSize(int position) {
                return (adapter.isHeaderView(position) || adapter.isBottomView(position)) ? mGridLayoutManager.getSpanCount() : 1;
            }
        });
        getSearchResult(pageNumber, curSortType, curRangeType);
     ...
     * @param rangeType
     */
    private void getSearchResult(int pageNo, String sort, String rangeType) {
        curSortType = sort;
