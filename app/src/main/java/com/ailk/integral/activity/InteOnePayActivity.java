 ...
 * 时间: 2016/5/19 18:48
 */
public class InteOnePayActivity extends BaseActivity implements View.OnClickListener{
    ...
    public void initView() {
        ...
        pay101Resp = (Pay101Resp) bundle.get("pay101Resp");
        if (pay101Resp != null) {
            if (pay101Resp.getRealMoney() != null) {
                tvRealMoney.setText(MoneyUtils.GoodListPrice(pay101Resp.getRealMoney()));
            }
            wayList = pay101Resp.getWayList();
        }
        if (wayList.size() > 0) {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_confirm:
                ...
                if (rbHong.isChecked()) {
                    requestAiPayInfo(pay101Resp);
                }
                if (rbAli.isChecked()) {
                    requestAliPayInfo(pay101Resp);
                }
                if (rbAbc.isChecked()) {
                    requestAbcPayInfo(pay101Resp);
                }
                if (rbWechat.isChecked()) {
                    requestWechatPayInfo(pay101Resp);
                }
                break;
        }
    }
     ...
     * @param resp
     */
    private void requestAbcPayInfo(Pay101Resp resp) {
     ...
     * @param resp
     */
    private void requestAiPayInfo(Pay101Resp resp) {
        if (System.currentTimeMillis() - lastRequest < CLICK_INTERVAL) {
            return;
        }
        lastRequest = System.currentTimeMillis();
                ...
                if (StringUtils.equalsIgnoreCase(Constant.UNION_PAY_ID, payWayItem.getId())) {
                    ...
                    NetCenter.build(this)
                        ...
                        public void call(Pay104Resp pay104Resp) {
                            ...
                            Intent intent = new Intent(InteOnePayActivity.this, AiPayActivity.class);
                        ...
                        public void call(Throwable throwable) {
                            ToastUtil.show(InteOnePayActivity.this, throwable.getMessage());
                        }
                    });
                }
            }
     ...
     * @param resp
     */
    private void requestAliPayInfo(final Pay101Resp resp) {
        if (System.currentTimeMillis() - lastRequest < CLICK_INTERVAL) {
            return;
        }
        lastRequest = System.currentTimeMillis();
                ...
                if (StringUtils.equalsIgnoreCase(Constant.ALI_PAY_ID, payWayItem.getId())) {
                    ...
                    getInteJsonService().requestPay104(this, req, true, new InteJsonService.CallBack<Pay104Resp>() {
                        ...
                        public void oncallback(Pay104Resp pay104Resp) {
                            ...
                            AliPayUtils aliPayUtils = new AliPayUtils(InteOnePayActivity.this);
    ...
    private void requestWechatPayInfo(Pay101Resp resp) {
        if (System.currentTimeMillis() - lastRequest < CLICK_INTERVAL) {
            return;
        }
        lastRequest = System.currentTimeMillis();
                ...
                if (StringUtils.equalsIgnoreCase(Constant.WECHAT_PAY_ID, payWayItem.getId())) {
                    ...
                    getInteJsonService().requestPay104(this, req, true, new InteJsonService.CallBack<Pay104Resp>() {
                        ...
                        public void oncallback(Pay104Resp pay104Resp) {
                            if (pay104Resp != null) {
                                Map<String, String> formData = pay104Resp.getFormData();
                                IWXAPI iwxapi = WXAPIFactory.createWXAPI(InteOnePayActivity.this, null);
