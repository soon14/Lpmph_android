 ...
 */
@InteHomeViewType(ViewType=30)
public class InteHomeThirtyHolder extends InteHomeViewHolder {

    private ImageView img0;
    private ImageView img1;
    private ImageView img2;

    public InteHomeThirtyHolder(Activity activity, LayoutInflater inflater, ViewGroup viewGroup) {
