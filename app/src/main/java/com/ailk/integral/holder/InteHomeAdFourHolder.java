 ...
 * 时间: 2016/10/11 15:54
 */
@InteHomeViewType(ViewType=240)
public class InteHomeAdFourHolder extends InteHomeViewHolder {
    ...
    public InteHomeAdFourHolder(Activity activity, LayoutInflater inflater, ViewGroup viewGroup) {
    ...
    public void initData(Cms101Resp.Model model) {
        ...
        setImageViewImg(items.get(0).getImgUrl(),img0,aq,140);
        setImageViewImg(items.get(1).getImgUrl(),img1,aq,140);
        setImageViewImg(items.get(2).getImgUrl(),img2,aq,140);
        setImageViewImg(items.get(3).getImgUrl(),img3,aq,140);
