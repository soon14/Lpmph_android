 ...
 */
@InteHomeViewType(ViewType=22)
public class InteHomeTwentyTwoHolder extends InteHomeViewHolder {

    private ImageView img0;
    private ImageView img1;

    public InteHomeTwentyTwoHolder(Activity activity, LayoutInflater inflater, ViewGroup viewGroup) {
        super(activity,inflater,viewGroup, R.layout.home_twenty_two_layout,R.dimen.home_modey_body_width,R.dimen.home_model_type9_height);
    }
