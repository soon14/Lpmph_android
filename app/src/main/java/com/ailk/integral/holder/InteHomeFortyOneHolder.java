...
public class InteHomeFortyOneHolder extends InteHomeViewHolder {
    ...
    public InteHomeFortyOneHolder(Activity activity, LayoutInflater inflater, ViewGroup viewGroup) {
