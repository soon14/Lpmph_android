 ...
 */
@InteHomeViewType(ViewType=21)
public class InteHomeTwentyOneHolder extends InteHomeViewHolder {

    private ImageView img0;
    private ImageView img1;

    public InteHomeTwentyOneHolder(Activity activity, LayoutInflater inflater, ViewGroup viewGroup) {
        super(activity,inflater,viewGroup, R.layout.home_twenty_one_layout,R.dimen.home_modey_body_width,R.dimen.home_model_type9_height);
    }
