 ...
 */
@InteHomeViewType(ViewType=4)
public class InteHomeFourHolder extends InteHomeViewHolder {
    ...
    public InteHomeFourHolder(Activity activity, LayoutInflater inflater, ViewGroup viewGroup) {
        super(activity,inflater,viewGroup, R.layout.home_four_layout,R.dimen.home_modey_body_width,R.dimen.home_model_type4_height);
    }
    ...
    public void initData(Cms101Resp.Model model) {
        ...
        setImageViewImg(items.get(2).getImgUrl(),img2,aq,320);
        setImageViewImg(items.get(3).getImgUrl(),img3,aq,320);
